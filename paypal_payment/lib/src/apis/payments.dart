...
class PaymentsApi {
  ...
  Future<Payment> createPayment(payment) async {
    var response = await _client.post(Uri.tryParse("https://api-m.sandbox.paypal.com/$_endPoint/payment")!,
        body: payment.toJson(),//JsonEncoder(payment is Payment ? payment.toJson() : payment),
        headers: {
